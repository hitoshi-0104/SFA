...
class CreateController {
	...
	/** 初期表示 */
	private static final String SHOW_MATCH = "lead.create.show.action";
	/** 連続登録 */
	private static final String CONTINUOUS_MATCH = "lead.create.continuous.action";
	/** 登録 */
	private static final String REGIST_MATCH = "lead.create.regist.action";
	/** 戻る */
	private static final String RETURN_MATCH = "lead.create.return.action";
